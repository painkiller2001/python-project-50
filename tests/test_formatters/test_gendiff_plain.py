...
def test_plain_added():
    ...
    assert get_format_plain_result(diff) == "Property 'b' was added with value: true"
...
def test_plain_changed():
    diff = [{"key": "b", "type": "changed", "old_value": None, "new_value": False}]
    assert get_format_plain_result(diff) == "Property 'b' was updated. From null to false"
...
def test_plain_complex_value():
    ...
    assert get_format_plain_result(diff) == "Property 'c' was added with value: [complex value]"